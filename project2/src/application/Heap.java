...
class Heap {
	private Tree[] Heap; // Array to store the elements of the heap
	...
	public Heap(int maxSize) {
		...
		this.size = 0;
		Heap = new Tree[maxSize + 1];
		Tree dummy = new Tree(0); // A dummy node with minimum frequency, used as a sentinel
		Heap[0] = dummy;
	}
	...
	public Tree remove() {
		Tree popped = Heap[1]; // The root of the heap, which is the minimum element
